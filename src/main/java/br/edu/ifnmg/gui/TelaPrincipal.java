...
//        
        if (current_cred.getUser().getRole().getName().equals("administrador")) {
            ...
            instance.menuApagaUsuario.setVisible(true);
            ...
            instance.menuComentario.setVisible(true);
...
//        instance.setTitle("Library System - " + credential.getUser().getName());
    ...
    private void initComponents() {
        ...
        menuApagaUsuario = new javax.swing.JMenuItem();
        ...
        menuComentario = new javax.swing.JMenu();
        ...
        relatorioLivros = new javax.swing.JMenuItem();
        relatorioUsers = new javax.swing.JMenuItem();
        relatorioComments = new javax.swing.JMenuItem();
        relatorioEmp = new javax.swing.JMenuItem();
        ...
        menuApagaUsuario.setText("Apagar Usuário");
        menuApagaUsuario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuApagaUsuarioActionPerformed(evt);
            }
        });
        menuUsuario.add(menuApagaUsuario);
        ...
        menuApagaLivro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                menuApagaLivroLivroActionPerformed(evt);
            }
        });
        ...
        menuAtualizaExemp.setText("Atualiza Exemplar");
        ...
        menuDeleteExemp.setText("Excluir Exemplar");
        ...
        menuComentario.setText("Comentário");
        ...
        menuComentario.add(menuComments);
        ...
        menuComentario.add(menuAtuaComentarios);
        ...
        menuComentario.add(menuApagaComentario);

        menu.add(menuComentario);
        ...
        relatorioLivros.setText("Livros");
        relatorioLivros.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                relatorioLivrosActionPerformed(evt);
            }
        });
        jMenu2.add(relatorioLivros);

        relatorioUsers.setText("Usuarios");
        relatorioUsers.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                relatorioUserActionPerformed(evt);
            }
        });
        jMenu2.add(relatorioUsers);

        relatorioComments.setText("Comentarios");
        relatorioComments.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                relatorioCommentActionPerformed(evt);
            }
        });
        jMenu2.add(relatorioComments);

        relatorioEmp.setText("Emprestimos");
        relatorioEmp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                relatorioRentalActionPerformed(evt);
            }
        });
        jMenu2.add(relatorioEmp);

        menuEmpres1.add(jMenu2);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(PanelPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 665, Short.MAX_VALUE)
        );
    ...
    private void menuVerUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuVerUsuarioActionPerformed
        VisualizarUsuario.getInstance().setVisible(true);
    ...
    private void menuHistoryEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuHistoryEmpActionPerformed
        HistoricoEmprestimo.getInstance().setVisible(true);
    ...
    private void menuApagaLivroLivroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuApagaLivroLivroActionPerformed
        // TODO add your handling code here:
        //this.setVisible(false);
        DeleteLivro.getInstance().setVisible(true);
    }//GEN-LAST:event_menuApagaLivroLivroActionPerformed
    ...
    private void menuCommentsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuCommentsActionPerformed
        // TODO add your handling code here:
        //this.setVisible(false);
        Comentario.getInstance().setVisible(true);
    ...
    private void menuCadExempActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuCadExempActionPerformed
        AdicionaExemplar.getInstance().setVisible(true);
    ...
    private void menuLivroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuLivroActionPerformed
        VisualizaLivros.getInstance().setVisible(true);
    ...
    private void menuAtuaComentariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuAtuaComentariosActionPerformed
        // TODO add your handling code here:
        AtualizaComentario.getInstance().setVisible(true);
    ...
    private void menuAtualizaExempActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuAtualizaExempActionPerformed
        AtualizaExemplar.getInstance().setVisible(true);
    ...
    private void menuApagaComentarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuApagaComentarioActionPerformed
        DeleteComentario.getInstance().setVisible(true);
    ...
    private void menuApagaUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuApagaUsuarioActionPerformed
        // TODO add your handling code here:
        ApagarUsuario.getInstance().setVisible(true);
    }//GEN-LAST:event_menuApagaUsuarioActionPerformed

    private void relatorioLivrosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_relatorioLivrosActionPerformed
        try (InputStream in = getClass().getResourceAsStream("/BookReport.jasper")) {
            ...
            popUp.setContentPane(jasperViewer.getContentPane());
            popUp.setSize(jasperViewer.getSize());
            popUp.setTitle("Relatorio de Livros");
            popUp.setModal(true);
    ...
    }//GEN-LAST:event_relatorioLivrosActionPerformed

    private void relatorioUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_relatorioUserActionPerformed
        try (InputStream in = getClass().getResourceAsStream("/userReport.jasper")) {
    ...
    }//GEN-LAST:event_relatorioUserActionPerformed

    private void relatorioCommentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_relatorioCommentActionPerformed
        try (InputStream in = getClass().getResourceAsStream("/CommentsReport.jasper")) {
    ...
    }//GEN-LAST:event_relatorioCommentActionPerformed

    private void relatorioRentalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_relatorioRentalActionPerformed
        try (InputStream in = getClass().getResourceAsStream("/EmprestimoReport.jasper")) {
    ...
    }//GEN-LAST:event_relatorioRentalActionPerformed
    ...
    private javax.swing.JMenuItem menuApagaUsuario;
    ...
    private javax.swing.JMenu menuComentario;
    ...
    private javax.swing.JMenuItem relatorioComments;
    private javax.swing.JMenuItem relatorioEmp;
    private javax.swing.JMenuItem relatorioLivros;
    private javax.swing.JMenuItem relatorioUsers;
