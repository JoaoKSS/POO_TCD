...
//</editor-fold>
    ...
    public static void emprestar(LocalDate diaRetorno, User librarian, User reader, int[] SelectedRows,JLabel label) throws Exception{
        ...
        for(Integer row: SelectedRows){
            if(copies.get(row).getEmprestimo()==null){
